const DE = {
    account: {
        ...
        walletPasswordTitle: "Wallet-Passwort",
...
Gesperrtes SMR-Guthaben: {Guthaben3}Send {token} amount: {amount}`,
        ...
        residueBelow1Tips: 'Der Restbetrag auf deiner Wallet kann nicht kleiner als 1 Miota betragen. Bitte ändere die Anzahl.',
...
`
    ...
    shimmer: {
        ...
        chooseAWallet: 'Wählen Sie ein Wallet, um Ihre ##SMR Staking Belohnungen## zu beanspruchen.',
        claimStakingRewards: 'SMR-Staking-Belohnungen beanspruchen',
        importTips: 'Bitte ##importieren Sie Ihre IOTA-Wallet## in TanglePay, um die Staking-Belohnung zu beanspruchen.',
        claim: 'Beanspruchen',
        claimingFailed: 'Fehler beim Beanspruchen',
        claimingFailedTips: 'Keine SMR-Staking-Belohnungen in Ihrer IOTA-Brieftasche ##{name} {address}## verfügbar.',
        understand: 'Ich bin einverstanden',
        smrClaimStakingReward: 'SMR-Staking-Belohnungen beansprucht',
        smrAmount: 'SMR-Betrag: ',
        createTips: 'Das neue Shimmer-Wallet hat dieselben Mnemonics und dasselbe Passwort wie Ihre IOTA-Wallet ##{name} {address}##.',
        createSuccTips: 'Zur Sicherheit Ihrer Vermögenswerte empfehlen wir Ihnen, das Passwort ihres Wallets zu ändern oder Gelder in eine neue Shimmer-Wallet zu übertragen.',
        tradingList: 'Tradingliste',
