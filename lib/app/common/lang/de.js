...
Locked SMR balance: {balance3}`,
    ...
    user: {
        ...
        enableBiometrics: 'Aktivieren der biometrischen Authentifizierung',
        bioVerification: 'Biometrische Überprüfung',
        noPrompt: 'Keine Anweisungen mehr',
        biometricsSucc:'Biometrische Authentifizierung erfolgreich',
        biometricsFailed: 'Biometrische Authentifizierung fehlgeschlagen',
        biometriceDialog: 'Um die Biometrie in den Einstellungen zu aktivieren, müssen Sie bei weiteren Transaktionen kein Passwort eintragen',
        manage: 'Bearbeite',
