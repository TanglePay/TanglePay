...
Gesperrtes SMR-Guthaben: {Guthaben3}Send {token} amount: {amount}`,
        ...
        evmGasNotSufficient:
            'Das {Token} auf der Adresse ist nicht ausreichend für die Transaktionsgebühr. Bitte einzahlen.',
        ...
        edit: 'Bearbeiten',
        getAssetsFail:
            'Die Synchronisation des Vermögenswerts ist fehlgeschlagen. Bitte scrollen Sie nach unten, um zu aktualisieren.',
        getActivityFail:
            'Die Synchronisation des Transaktionsverlaufs ist fehlgeschlagen. Bitte scrollen Sie nach unten, um zu aktualisieren.'
    },
    user: {
        me: 'Profil',
        ...
        biometriceDialog:
            'Wenn die biometrische Authentifizierung aktiviert ist, wird für nachfolgende Transaktionen kein Passwort mehr benötigt.',
...
`
    ...
    shimmer: {
        ...
        importTips:
            'Bitte ##importieren Sie Ihre IOTA-Wallet## in TanglePay, um die Staking-Belohnung zu beanspruchen.',
        claim: 'Beanspruchen',
        ...
        createTips:
            'Das neue Shimmer-Wallet hat dieselben Mnemonics und dasselbe Passwort wie Ihre IOTA-Wallet ##{name} {address}##.',
        createSuccTips:
            'Zur Sicherheit Ihrer Vermögenswerte empfehlen wir Ihnen, das Passwort ihres Wallets zu ändern oder Gelder in eine neue Shimmer-Wallet zu übertragen.',
        tradingList: 'Tradingliste',
