...
Going Beyond Blockchain`,
        ...
        exportMnemonic: 'Export mnemonic phrases',
        ...
        showKeyMnemonic: 'Show Mnemonic Phrases',
        copyKeyTipsMnemonic: 'This is your mnemonic phrases (click to copy)',
        showKeyTipsMnemonic: 'Warning: Never disclose this key. Anyone with your mnemonic phrases can steal any assets held in your account.',
        done: 'Fertig',
        ...
        collectSuccTips: 'Die Ausgangskonzentration ist abgeschlossen.',
    ...
    assets: {
        ...
        sendSuccRestake: 'Transaktion erfolgreich.',
...
Betrag {token}: {Betrag}
EGeschätzte Speicherkaution: {Kaution} {unit}
Verfügbares {token}-Guthaben: {Guthaben1}
Verfügbares {platformToken}-Guthaben: {Guthaben2}
Gesperrtes {platformToken}-Guthaben: {Guthaben3}Send {token} amount: {amount}`,
        ...
        sendSuccRestakeTips: 'Transaktion erfolgreich.',
        ...
        unlockError: 'There is not enough {token} in the address to claim this token.',
        locked: 'locked',
        ...
        sendConfirmation: 'Sendebestätigung',
        sendConfirmationTips: 'Bitte bestätigen Sie das Senden dieser Transaktion',
        sendInsufficientNfts: 'NFT kann nicht gefunden werden.',
        sendInsufficientNativeToken: '{token} ist nicht ausreichend.',
        sendInsufficientCash: 'Es gibt nicht genug {cash}.',
        sendAmountTooSmall: 'Überweisungsbetrag darf nicht niedriger als {amount} sein.',
        sendStorageDepositNotEnough: 'Speicherplatz-Einzahlung ist nicht ausreichend.',
        sendInsufficientCashForRemainderDeposit: 'Der verbleibende Betrag von {amount} reicht nicht aus, um die Speicherplatz-Einzahlung zu bezahlen.'
    },
    user: {
        me: 'Profil',
        manageWallets: 'Account verwalten',
        setting: 'Einstellung',
        network: 'Netzwerk',
        privacy: 'Privacy',
