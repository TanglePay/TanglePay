...
Do not share or store mnemonic through network, such as screenshots, email, social media, etc.`,
        ...
        backupScreenshoptTips: 'Please do not take screenshorts of the mnemonic, it may be collected by third-party, resulting in loss of assets',
        ...
        mnemonicSubTitle: 'These mnemonic words are for recovering your wallet. Please record them in the correct order. ',
        ...
        mnemonicPhraseTips2: 'Do not share or store mnemonic through network, such as screenshots, email, social media, etc.',
...
Going Beyond Blockchain`,
        ...
        showKeyTips: 'Warning: Never disclose this key. Anyone with your private keys can steal any assets held in your account.',
        done: 'Done',
...
Locked SMR balance: {balance3}`,
    ...
    user: {
        ...
        biometriceDialog: 'When the biometrics authentication is enabled, the password will no longer be required for the subsequent transactions',
...
`
    ...
    shimmer: {
        ...
        createTips: 'The new Shimmer wallet has the same mnemonics and password as your IOTA wallet ##{name} {address}##.',
        createSuccTips: 'For the safetly of your assets, we suggest you to change the wallet password or transfer fund into a new Shimmer wallet.',
        tradingList: 'Trading List',
