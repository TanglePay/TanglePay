const DE = {
    account: {
        ...
        create: 'Erstelle eine neue Konto',
        hasWallet: 'Ich habe bereits eine Konto',
        ...
        intoName: 'Gib der Konto einen Namen ',
        intoNameTips: 'Bitte gib einen Namen ein ',
        intoPassword: 'Passwort deiner Konto',
...
Teilen oder speichern Sie die Mnemonic nicht über das Netzwerk, wie zum Beispiel durch Screenshots, E-Mail, soziale Medien usw.`,
        ...
        backupScreenshoptTips: 'Mach bitte keine Bildschirmaufnahme, Sie könnte von Angreifern genutzt werden und dich deine Vermögenswerte kosten',
        ...
        gotoWallet: 'Gehen Sie zum Konto',
...
Going Beyond Blockchain`,
        ...
        showKeyTips: 'Achtung: Teile deinen Private Key niemals mit anderen Personen. Jeder mit deinem Private Key könnte die Assets von deinem Konto stehlen.',
        done: 'Fertig',
        viewInExplorer: 'Account im Explorer anzeigen',
        or: 'oder',
        importDuplicate: 'Diese Konto existiert bereits',
        privateKeyImport: 'Private Key importieren',
        inputPrivateKey: 'Bitte gib deinen Private Key ein',
        removeTitle: 'Konto entfernen',
        removeTips: `Diese Konto wird von deinem Gerät entfernt.
...
Wiederherstellungsphrase oder des Private Keys bist, bevor du fortfährst.`,
    ...
    assets: {
        ...
        activity: 'Historie',
        search: 'Suche',
        myWallets: 'Meine Konten',
        addWallets: 'Konten hinzufügen',
        copied: 'kopiert',
        currency: 'Währung',
        receiver: 'Empfänger',
        ...
        noWallet: 'Du hast noch keine Konto hinzugefügt',
...
Gesperrtes SMR-Guthaben: {Guthaben3}Send {token} amount: {amount}`,
        ...
        residueBelow1Tips: 'Der Restbetrag auf deiner Konto kann nicht kleiner als 1 Miota betragen. Bitte ändere die Anzahl.',
    ...
    user: {
        me: 'Profil',
        manageWallets: 'Konten verwalten',
        setting: 'Einstellung',
        network: 'Netzwerk',
        privacy: 'Privacy',
        ...
        biometriceDialog: 'Wenn die biometrische Authentifizierung aktiviert ist, wird für nachfolgende Transaktionen kein Passwort mehr benötigt.',
        goSetting: 'Einstellungen',
        manage: 'Bearbeite',
        backupWallet: 'Backup Konto',
        backupWalletTips: `In eine .Stronghold Datei exportieren - eine komplett verschlüsselte Backup Datei ihrer Konto inklusive Transaktionshistorie`,
        export: 'Exportieren',
    ...
    staking: {
        ...
        noAvailableTips: 'Deine Konto ist leer. Transferiere Guthaben in deine Konto um zu Staken.',
...
`,
    ...
    shimmer: {
        ...
        chooseAWallet: 'Wählen Sie ein Konto, um Ihre ##SMR Staking Belohnungen## zu beanspruchen.',
        claimStakingRewards: 'SMR-Staking-Belohnungen beanspruchen',
        importTips: 'Bitte ##importieren Sie Ihre IOTA-Konto## in TanglePay, um die Staking-Belohnung zu beanspruchen.',
        claim: 'Beanspruchen',
        claimingFailed: 'Fehler beim Beanspruchen',
        claimingFailedTips: 'Keine SMR-Staking-Belohnungen in Ihrer IOTA-Konto ##{name} {address}## verfügbar.',
        understand: 'Ich bin einverstanden',
        smrClaimStakingReward: 'SMR-Staking-Belohnungen beansprucht',
        smrAmount: 'SMR-Betrag: ',
        createTips: 'Das neue Shimmer-Konto hat dieselben Mnemonics und dasselbe Passwort wie Ihre IOTA-Konto ##{name} {address}##.',
        createSuccTips: 'Zur Sicherheit Ihrer Vermögenswerte empfehlen wir Ihnen, das Passwort ihres Konten zu ändern oder Gelder in eine neue Shimmer-Konto zu übertragen.',
        tradingList: 'Tradingliste',
