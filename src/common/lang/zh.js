...
`,
    ...
    shimmer: {
        ...
        chooseAWallet: '選擇一個錢包來領取##SMR Staking獎勵##',
        claimStakingRewards: '獲取SMR Staking收益',
        importTips: '如果你要獲取收益的IOTA錢包不在列表內，請先在Tanglepay中 ##導入IOTA錢包##.',
        claim: '獲取',
        claimingFailed: '獲取失敗',
        claimingFailedTips: '您的IOTA錢包##{name} {address}##中沒有可以Claim的Shimmer Staking Rewards',
        understand: '我已知曉',
        smrClaimStakingReward: 'SMR Staking 獎勵已領取',
        smrAmount: 'SMR數量：',
        createTips: '新創建的Shimmer錢包助記詞與初始密碼與您的IOTA錢包 ##{name} {address}##一致',
        createSuccTips: '為了您的資產安全，建議您修改錢包密碼或者將資產轉移到全新的Shimmer錢包',
        tradingList: '交易列表',
